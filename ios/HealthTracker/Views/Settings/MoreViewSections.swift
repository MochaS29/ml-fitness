...
// MARK: - MoreMenuItem (shared row component)
...
// MARK: - Section: Pro Upgrade Banner
...
// MARK: - Section: Tracking Tools

struct TrackingToolsSection: View {
    @Binding var showingFoodSearch: Bool
    @Binding var showingExerciseSearch: Bool
...
// MARK: - Section: Progress & Analysis

struct ProgressAnalysisSection: View {
...
// MARK: - Section: Developer Tools (DEBUG only)
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 16) {
                ...
                Group {
                    ...
                    Text("• No account is required, and we never track you across other apps or websites")
